...
skills = [crea_skill("Monte-Attaque", 5, Increase, ["attack", 1, 3], 1, 0, "Augmente l'attaque physique d'un niveau.", 0, 0, 4, effect_increase_attack, false),
		  crea_skill("Frappalame", 5, Atk_puiss, 50, 1, 1, "Lance une puissante attaque circulaire. #Type : Tranche   Element : Neutre #Puissance : ***", "weapon", "weapon", 5, false, snd_strong_attack1)]
