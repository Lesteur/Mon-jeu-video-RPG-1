global.germicroque = {
	...
	skills : [crea_skill("Photosynthèse", 0, PV_recup, 15, 0, 0, "<enemy> se soigne !", "heal", false, 0, effect_heal_pv , false),
			  crea_skill("Esprit de bête", 0, Increase, ["attack", 1, 3], 0, 0, "<enemy> se renforce !", "increase", false, 0, effect_increase_attack, false),
